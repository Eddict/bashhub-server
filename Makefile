...
IMAGE_NAME="eddict/bashhub-server"
...
build:
	...
	@echo "GOPATH=$(GOPATH)"
	go build  -ldflags "-X github.com/eddict/bashhub-server/cmd.Version=$(VERSION) -X github.com/eddict/bashhub-server/cmd.GitCommit=$(GIT_COMMIT) -X github.com/eddict/bashhub-server/cmd.BuildDate=$(BUILD_DATE)" -o bin/${BIN_NAME}

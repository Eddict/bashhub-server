# bashhub-server
[![CI](https://github.com/eddict/bashhub-server/actions/workflows/tests.yml/badge.svg)](https://github.com/eddict/bashhub-server/actions/workflows/tests.yml) <img src="https://img.shields.io/docker/pulls/eddict/bashhub-server.svg">
[![Go Report Card](https://goreportcard.com/badge/github.com/eddict/bashhub-server)](https://goreportcard.com/report/github.com/eddict/bashhub-server) 
...
- Very simple drop in replacement for bashhub.com server and easy to [install](https://github.com/eddict/bashhub-server#installation) and get running with existing bashhub-client and bh command.
- All the benefits of bashhub without having to send your shell history to a third-party
- [Regex](https://github.com/eddict/bashhub-server#using-regex) search
- [Import](https://github.com/eddict/bashhub-server#transferring-history-from-bashhubcom) old history from bashhub.com
...
#### Docker 
```
$ docker pull eddict/bashhub-server
```
#### Go
...
```
#### Releases 
Binaries for various os and architectures can be found in [releases](https://github.com/eddict/bashhub-server/releases).
...
```
$ docker run -d -p 8080:8080 --name bashhub-server  eddict/bashhub-server 
```
